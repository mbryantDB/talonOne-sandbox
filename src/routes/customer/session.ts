...
customerSessionRouter.put('/:integration', async (req: any, res: any): Promise<any> => {
...
customerSessionRouter.put('/:integrationId/reopen', async (req: any, res: any): Promise<any> => {
